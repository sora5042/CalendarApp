...
//    static let calendarViewController = UIStoryboard(name: "Calendar", bundle: nil).instantiateViewController(withIdentifier: "CalendarViewController") as! CalendarViewController
//
...
//        let authorization = calendarViewController.authorization
//        if let gtmAppAuth = GTMAppAuthFetcherAuthorization(fromKeychainForName: "authorization") {
//            calendarViewController.authorization = gtmAppAuth
//        }
//
//        if authorization == nil {
//            calendarViewController.showAuthorizationDialog(callBack: {(error) -> Void in
//                if error == nil {
...
//        var authorization = calendarViewController.authorization
